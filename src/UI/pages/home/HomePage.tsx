...
export default Vue.extend({
	...
	render(): Vue.VNode {
		...
		const renderCandidates = () => {
			...
			return (
				<v-container fluid>
					<CandidatesComponent ref='CandidatesComponent' candidates={this.$store.getters['candidate/get']}/>
				</v-container>
			)
		}
			...
			<v-container fluid>
				<v-row no-gutters>
					...
					<v-col cols={7}>
						<v-row no-gutters>
							<v-col>
								{ renderStamps('science') }
							</v-col>
							<v-col>
								{ renderStamps('template') }
							</v-col>
							<v-col>
								{ renderStamps('difference') }
							</v-col>
						</v-row>
						<v-row no-gutters>
							<v-col>
